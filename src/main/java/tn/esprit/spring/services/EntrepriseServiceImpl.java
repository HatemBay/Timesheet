...
public class EntrepriseServiceImpl implements IEntrepriseService {
	...
	public List<String> getAllDepartementsNamesByEntreprise(int entrepriseId) {
		Optional<Entreprise> entrepriseManagedEntityOptional = entrepriseRepoistory.findById(entrepriseId);
		List<String> depNames = new ArrayList<>();
		if (entrepriseManagedEntityOptional.isPresent()) {
			Entreprise entrepriseManagedEntity = entrepriseManagedEntityOptional.get();
